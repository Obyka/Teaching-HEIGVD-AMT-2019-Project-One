                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Modifier un viewer</h1>
                        </div>
                        <form class="user" method="POST" action="./modifyviewer">
                            ...
                            <div class="form-group">
                                <input type="date" name="birthdate" class="form-control" placeholder="Date de naissance: yyyy-mm-dd" value="${viewer.birthDate}" required="true">
                            </div>
