                        ...
                        <div class="pagination">
                            <c:choose>
                                <c:when test="${nbPage>5 && pagetable <=2}">
                                    ...
                                    <a href=<c:out value="./detailserie?pagetable=${nbPage-1}&idserie=${serie.id}"/>><c:out value="Dernière page"/></a>
                                </c:when>
                                <c:when test="${nbPage>5 && pagetable > 2 && pagetable < nbPage-2}">
                                    <a href=<c:out value="./detailserie?pagetable=${0}&idserie=${serie.id}"/>><c:out value="Première page"/></a>
                                    <c:forEach begin="1" end="5" var="val">
                                        <a href=<c:out value="./detailserie?pagetable=${pagetable - 2 + val-1}&idserie=${serie.id}"/>><c:out value="${pagetable - 2+ val}"/></a>
                                    </c:forEach>
                                    <a href=<c:out value="./detailserie?pagetable=${nbPage-1}&idserie=${serie.id}"/>><c:out value="Dernière page"/></a>
                                </c:when>
                                <c:when test="${nbPage>5 && pagetable > 2 && pagetable >= nbPage-2}">
